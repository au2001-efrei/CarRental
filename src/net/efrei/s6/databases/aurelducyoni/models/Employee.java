...
public class Employee extends Observable<Employee> {
    ...
    public Employee(int id, Agency agency, String firstName, String lastName, String streetNumber, String streetName, String postalCode, String city, String phone, String passwordHash) {
        this.id = id;
        this.agency = agency;
    ...
    public boolean checkPassword(String password) {
        return PasswordHash.verify(getPasswordHash(), password);
    }
